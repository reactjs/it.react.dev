...
Questa pagina è stata tradotta automaticamente e supervisionata da un maintainer. Un'ulteriore revisione da parte della community sarebbe comunque utile. [Migliora questa traduzione](https://github.com/reactjs/it.react.dev/edit/main/src/content/community/meetups.md).

</Note>

<Intro>

Hai un meetup React.js locale? Aggiungilo qui! (Mantieni l'elenco in ordine alfabetico)
...
## Inghilterra (Regno Unito) {/*england-uk*/}
...
## Scozia (Regno Unito) {/*scotland-uk*/}
