    ...
    <>
      <div className="ps-0">
        ...
        <Section background="left-card">
          <Center>
            <Header>Crea interfacce utente dai componenti</Header>
            <Para>
              React ti permette di creare interfacce utente a partire da
              componenti individuali. Crea i tuoi componenti React come{' '}
              <Code>Thumbnail</Code>, <Code>LikeButton</Code>, e{' '}
              <Code>Video</Code>. Poi combinali per creare interfacce, pagine ed
              app.
            </Para>
          </Center>
          <FullBleed>
          ...
          <Center>
            <Para>
              Sia che lavoriate in solitaria o con migliaia di altri
              sviluppatori, utilizzare React è sempre lo stesso. È stato
              progettato per permettervi di combinare facilmente componenti
              scritti da persone, team e organizzazioni indipendenti.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            <Header>Scrivi componenti con logica e markup</Header>
            <Para>
              I componenti React sono funzioni JavaScript. Vuoi mostrare del
              contenuto in modo condizionale? Usa un <Code>if</Code>. Vuoi
              mostrare una lista? Prova <Code>map()</Code>. Imparare React è
          ...
          <Center>
            <Para>
              Questa sintassi di markup è chiamata JSX. È una sintassi
              JavaScript estesa popularizzata da React. Mettere JSX markup
              vicino alla logica di rendering relativa rende i componenti React
              facili da creare, mantenere e cancellare.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="left-card">
          <Center>
            <Header>Aggiungi interattività ovunque tu abbia bisogno</Header>
            <Para>
              I componenti React ricevono dati e ritornano quello che dovrebbe
              apparire sullo schermo. Puoi passargli nuovi dati in risposta ad
              una interazione, come quando l&apos;utente digita in un input.
              React aggiornerà lo schermo per corrispondere ai nuovi dati.
            </Para>
          </Center>
          <FullBleed>
            <Example3 />
          ...
          <Center>
            <Para>
              Non devi costruire tutta la tua pagina in React. Aggiungi React
              alla tua pagina HTML esistente e renderizza componenti React
              interattivi ovunque.
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
                ...
                Aggiungi React alla tua pagina
              </CTA>
            </div>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            <Header>
              Vai full-stack <br className="hidden lg:inline" />
              con un framework
            </Header>
            <Para>
          ...
          <Center>
            <Para>
              React è anche un&apos;architettura. I framework che la
              implementano ti permettono di recuperare dati in componenti
              asincroni che funzionano sul server o addirittura durante la
              compilazione. Leggi dati da un file o un database e passali ai
              tuoi componenti interattivi.
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
                color="gray"
        ...
        <Section background="left-card">
          <div className="mx-auto flex flex-col w-full">
            <div className="mx-auto max-w-4xl lg:text-center items-center px-5 flex flex-col">
              <Header>Usa il meglio di ogni piattaforma</Header>
              <Para>
                Le persone amano le app web e native per motivi diversi. React
                ti permette di creare app web e native utilizzando le stesse
                competenze. Si basa sulle forze uniche di ogni piattaforma per
                far sentire le tue interfacce proprio come dovrebbero su ogni
                piattaforma.
              </Para>
            </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative flex items-start justify-center flex-col flex-1 pb-16 pt-5 gap-3 px-5 lg:px-10 lg:pt-8">
                      ...
                      <p className="lg:text-xl leading-normal text-secondary">
                        Le persone si aspettano che le pagine delle app web
                        carichino velocemente. Sul server, React ti permette di
                        iniziare a inviare HTML mentre stai ancora recuperando i
                        dati, riempiendo progressivamente il contenuto rimanente
                        prima che venga caricato alcun codice JavaScript. Sul
                        client, React può utilizzare le API standard del web per
                        mantenere la tua interfaccia utente reattiva anche
                    ...
                    <div className="bg-gradient-right dark:bg-gradient-right-dark px-3 sm:px-3 pb-12 lg:pb-20 rounded-lg overflow-hidden">
                      ...
                      <div className="flex flex-col items-start justify-center pt-0 gap-3 px-2.5 lg:pt-8 lg:px-8">
                        ...
                        <p className="h-full lg:text-xl text-secondary dark:text-secondary-dark leading-normal">
                          Le persone si aspettano che le app native si
                          comportino come la piattaforma d&apos;origine.{' '}
...
>>>>>>> 722b54640ea8ef146ef59558100819a6bb31c252
                <Para>
                  ...
                  oltre un miliardo di utenti. Più di 100.000 componenti React
                  di Meta aiutano a validare ogni strategia di migrazione.
                </Para>
                <div className="order-last pt-5">
                  <Para>
                    Il team di React è sempre alla ricerca di modi per
                    migliorare React. Alcune ricerche richiedono anni per dare i
                    loro frutti. React ha un alto livello di qualità per
                    prendere in considerazione un&apos;idea di ricerca per la
                    produzione. Solo approcci provati diventano parte di React.
                  </Para>
                  <div className="hidden lg:flex justify-start w-full">
                    <CTA color="gray" icon="news" href="/blog">
                      Leggi le ultime notizie su React
                    </CTA>
                  </div>
                </div>
              </div>
        ...
        <Section background="left-card">
          <div className="w-full">
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Header>
                  Accedi a una comunità
                  <br className="hidden lg:inline" />
                  di milioni
                </Header>
                <Para>
                  Non sei solo. Due milioni di sviluppatori da tutto il mondo
                  visitano la documentazione di React ogni mese. React è
                  qualcosa che le persone ed i team possono trovare accordo.
                </Para>
              </Center>
            </div>
            <CommunityGallery />
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Para>
                  Ecco perché React è molto di più di una libreria,
                  un&apos;architettura o un ecosistema. React è una comunità. È
                  un luogo dove puoi chiedere aiuto, trovare opportunità e
                  incontrare nuovi amici. Incontrerai sia sviluppatori che
                  designer, principianti e esperti, ricercatori e artisti,
                  insegnanti e studenti. Le nostre esperienze possono essere
                  molto diverse, ma React ci permette di creare interfacce
                  utente insieme.
                </Para>
              </Center>
            </div>
