...
Con un componente controllato, ogni valore dell'input viene controllato dallo stato di React. Anche se ciò comporta di dover scrivere codice aggiuntivo, rende possible il passaggio del valore anche ad altri elementi della UI, o di reimpostarlo tramite altri _event handlers_.
